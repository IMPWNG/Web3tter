...
const Web3DappContext = createContext();

export function Web3DappWrapper({ children }) {
    ...
    return (
        <Web3DappContext.Provider value={{ walletAddress, chainId, selectedCategory, setSelectedCategory, contractABI, setContractABI, contractAddress, setContractAddress }}>
            {children}
        </Web3DappContext.Provider>
    );
   
}

export function useWeb3DappContext() {
    return useContext(Web3DappContext);
}
